package ar.edu.huergo.scaputo.sbigliardi.nextmatch.config.security;
...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        // - Deshabilitamos CSRF porque no usamos cookies/sesiones en un equipo stateless.
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/mascotas/**").hasRole("ADMIN")
                        ...
                        .hasRole("ADMIN").requestMatchers(HttpMethod.DELETE, "/equipo/**")
    ...
    DaoAuthenticationProvider daoAuthenticationProvider(UserDetailsService userDetailsService,
        ...
        // para validar credentials en /equipo/auth/login.
